...
<template>
	...
	<!-- ============================ Page Title Start================================== -->
	<section class="page-head bg-cover" style="background:#017efa url(https://placehold.co/2000x1500) no-repeat;"
		data-overlay="4">
		<div class="container">
			<div class="row">
			...
			<div class="row align-items-center justify-content-between">
				...
				<div class="col-lg-6 col-md-6">
					<div class="story-wrap explore-content">
						...
						<p class="fw-light mb-4">At vero eos et accusamus et iusto odio dignissimos ducimus qui
